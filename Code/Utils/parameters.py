...
def parse_args():
    ...
    parser.add_argument("--save_dev_results", type=str2bool, default=False, 
                       help="Whether to save the test results (recommendations, user similarity and candidate diversity). Default is False.") # utils.str2bool
    ...
    parser.add_argument("--enable_gpu", type=str2bool, default=True, 
                       help="Whether to use the GPU or not. Default is True.") # utils.str2bool
    ...
    parser.add_argument("--num_words_title", type=int, default=22, 
                       help="Maximum token length of the title. Default is 22 (no truncation for 90% of the data).")
    parser.add_argument("--num_words_abstract", type=int, default=101,
                       help="Maximum token length of the abstract. Default is 101 (no truncation for 90% of the data).")
    ...
    parser.add_argument("--do_lower_case", type=str2bool, default=True, 
                       help="Whether to lower case the data when using NRMS or NAML. Default is True.") # utils.str2bool
